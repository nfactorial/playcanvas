...
new pc.Vec3,x=new pc.Vec3,v=new pc.Vec3,w=new pc.Vec3,y=new pc.Vec3,A=new pc.Mat4,B=new pc.Mat3,D=new pc.Mat3,H=1,L,I=new pc.Mat4,K=new pc.Vec3,F=new pc.Vec3,C=new pc.Vec3;new pc.Vec3;var O=new pc.Vec3,U=new pc.Vec3,W,Z,Y=function(b,c){this.graphicsDevice=b;this.precision=32;this._addTimeTime=0;if(!Y.DEFAULT_PARAM_TEXTURE){var d=new Float32Array(1024),f,g,e,p;for(g=0;16>g;g++)for(f=0;16>f;f++)e=f+1-8.5,p=g+1-8.5,p=Math.max(Math.min(1-Math.max(Math.min(Math.sqrt(e*e+p*p)/16,1),0)-.5,1),0),e=16*g+f,
d[4*e]=1,d[4*e+1]=1,d[4*e+2]=1,d[4*e+3]=p;Y.DEFAULT_PARAM_TEXTURE=h(b,16,16,d,pc.PIXELFORMAT_R8_G8_B8_A8,1,!0);Y.DEFAULT_PARAM_TEXTURE.minFilter=pc.FILTER_LINEAR;Y.DEFAULT_PARAM_TEXTURE.magFilter=pc.FILTER_LINEAR}W=this;Z=c;a("numParticles",1);this.numParticles>b.maxTextureSize&&(console.warn("WARNING: can't create more than "+b.maxTextureSize+" particles on this device."),this.numParticles=b.maxTextureSize);a("rate",1);a("rate2",this.rate);a("lifetime",50);a("emitterExtents",new pc.Vec3(0,0,0));
a("emitterRadius",0);a("emitterShape",pc.EMITTERSHAPE_BOX);a("initialVelocity",1);a("wrap",!1);a("localSpace",!1);a("wrapBounds",null);a("colorMap",Y.DEFAULT_PARAM_TEXTURE);a("normalMap",null);a("loop",!0);a("preWarm",!1);a("sort",pc.PARTICLESORT_NONE);a("mode",pc.PARTICLEMODE_GPU);a("scene",null);a("lighting",!1);a("halfLambert",!1);a("intensity",1);a("stretch",0);a("alignToMotion",!1);a("depthSoftening",0);a("mesh",null);a("depthWrite",!1);a("noFog",!1);a("blendType",pc.BLEND_NORMAL);a("node",null);
...
this.frameRandom.x=Math.random();this.frameRandom.y=Math.random();this.frameRandom.z=Math.random();this.particleTex=new Float32Array(this.numParticlesPot*r*4);var c=null===this.node||this.localSpace?pc.Vec3.ZERO:this.node.getPosition();this.emitterShape===pc.EMITTERSHAPE_BOX&&(null===this.node?I.setTRS(pc.Vec3.ZERO,pc.Quat.IDENTITY,this.spawnBounds):I.setTRS(pc.Vec3.ZERO,this.node.getRotation(),C.copy(this.spawnBounds).mul(this.node.localScale)));for(a=0;a<this.numParticles;a++)this.calcSpawnPosition(c,
...
this.qAlpha2,this.alphaUMax);if(this.pack8){var e=[0,0,0];c(this.qVelocity,e);var m=[0,0,0];c(this.qVelocity2,m);g=[0,0,0];c(this.qLocalVelocity,g);var k=[0,0,0];c(this.qLocalVelocity2,k);var l=Math.max(e[0],m[0]),l=Math.max(l,e[1]),l=Math.max(l,m[1]),l=Math.max(l,e[2]),l=Math.max(l,m[2]),e=Math.max(g[0],k[0]),e=Math.max(e,g[1]),e=Math.max(e,k[1]),e=Math.max(e,g[2]),e=Math.max(e,k[2]);this.maxVel=l+e}if(!this.useCpu){this.internalTex0=h(f,a,1,b(this.qLocalVelocity,this.qLocalVelocityDiv));this.internalTex1=
h(f,a,1,b(this.qVelocity,this.qVelocityDiv));g=this.qRotSpeed;for(var k=this.qScale,l=this.qScaleDiv,e=this.qRotSpeedDiv,m=this.qAlphaDiv,n=Array(4*g.length),p=0;p<g.length;p++)n[4*p]=g[p],n[4*p+1]=k[p],n[4*p+2]=0,n[4*p+3]=(255*l[p]<<16|255*e[p]<<8|255*m[p])/16777216;this.internalTex2=h(f,a,1,n)}g=this.qColor;k=this.qAlpha;l=Array(4*k.length);for(e=0;e<k.length;e++)l[4*e]=g[3*e],l[4*e+1]=g[3*e+1],l[4*e+2]=g[3*e+2],l[4*e+3]=k[e];this.internalTex3=h(f,a,1,l,pc.PIXELFORMAT_R8_G8_B8_A8,1,!0)},_initializeTextures:function(){this.colorMap&&
...
function(f,e){f?b&&b(f):this._preloadScripts(e,function(){var f=d.open(a,e);c.loader.clearCache(a,"scene");c.loader.patch({resource:f,type:"scene"},c.assets);c.root.addChild(f.root);c.systems.rigidbody&&"undefined"!==typeof Ammo&&c.systems.rigidbody.setGravity(f._gravity.x,f._gravity.y,f._gravity.z);b&&b(null,f)})}.bind(this))},_preloadScripts:function(b,c){if(pc.script.legacy){var d=this;d.systems.script.preloading=!0;var f=this._getScriptReferences(b),e=0,l=f.length,k=new a(l),n,r=/^http(s)?:\/\//;
if(l)for(var p=function(a,b){a&&console.error(a);k.inc();k.done()&&(d.systems.script.preloading=!1,c())},e=0;e<l;e++)n=f[e],!r.test(n.toLowerCase())&&d._scriptPrefix&&(n=pc.path.join(d._scriptPrefix,f[e])),this.loader.load(n,"script",p);else d.systems.script.preloading=!1,c()}else c()},_parseApplicationProperties:function(a,b){this._width=a.width;this._height=a.height;a.use_device_pixel_ratio&&(this.graphicsDevice.maxPixelRatio=window.devicePixelRatio);this.setCanvasResolution(a.resolution_mode,this._width,
this._height);this.setCanvasFillMode(a.fill_mode,this._width,this._height);a.vr&&a.vr_polyfill_url&&(pc.VrManager.isSupported||a.libraries.push(a.vr_polyfill_url));this._loadLibraries(a.libraries,b)},_loadLibraries:function(a,b){var c=a.length,d=c,f=this,e=/^http(s)?:\/\//;if(c)for(var k=function(a,c){d--;a?b(a):0===d&&(f.onLibrariesLoaded(),b(null))},n=0;n<c;++n){var r=a[n];!e.test(r.toLowerCase())&&f._scriptPrefix&&(r=pc.path.join(f._scriptPrefix,r));this.loader.load(r,"script",k)}else b(null)},
_parseAssets:function(a){var b=[],c={};if(pc.script.legacy)for(e in a)b.push(a[e]);else{for(var d=0;d<this.scriptsOrder.length;d++){var e=this.scriptsOrder[d];a[e]&&(c[e]=!0,b.push(a[e]))}for(e in a)c[e]||b.push(a[e])}for(d=0;d<b.length;d++)a=b[d],c=new pc.Asset(a.name,a.type,a.file,a.data),c.id=parseInt(a.id),c.preload=a.preload?a.preload:!1,c.tags.add(a.tags),this.assets.add(c)},_getScriptReferences:function(a){var b,c,d=[];a.settings.priority_scripts&&(d=a.settings.priority_scripts);var e=[],l=
{};for(b=0;b<d.length;b++)e.push(d[b]),l[d[b]]=!0;a=a.entities;for(c in a)if(a[c].components.script)for(d=a[c].components.script.scripts,b=0;b<d.length;b++)l[d[b].url]||(e.push(d[b].url),l[d[b].url]=!0);return e},start:function(){this.fire("start",{timestamp:pc.now(),target:this});if(!this._librariesLoaded)this.onLibrariesLoaded();pc.ComponentSystem.initialize(this.root);this.fire("initialize");pc.ComponentSystem.postInitialize(this.root);this.fire("postinitialize");this.tick()},update:function(a){this.graphicsDevice.updateClientRect();
this.vr&&this.vr.poll();pc.script.legacy&&pc.ComponentSystem.fixedUpdate(1/60,this._inTools);pc.ComponentSystem.update(a,this._inTools);pc.ComponentSystem.postUpdate(a,this._inTools);this.fire("update",a);this.controller&&this.controller.update(a);this.mouse&&this.mouse.update(a);this.keyboard&&this.keyboard.update(a);this.gamepads&&this.gamepads.update(a)},render:function(){this.fire("prerender");var a=this.systems.camera.cameras,b,c=this.renderer;this.root.syncHierarchy();for(var e=0,m=a.length;e<
m;e++)b=a[e],b.frameBegin(),c.render(this.scene,b.camera),b.frameEnd()},_fillFrameStats:function(a,b,c){var d=this.stats.frame;d.dt=b;d.ms=c;a>d._timeToCountFrames?(d.fps=d._fpsAccum,d._fpsAccum=0,d._timeToCountFrames=a+1E3):d._fpsAccum++;d.cameras=this.renderer._camerasRendered;d.materials=this.renderer._materialSwitches;d.shaders=this.graphicsDevice._shaderSwitchesPerFrame;d.shadowMapUpdates=this.renderer._shadowMapUpdates;d.shadowMapTime=this.renderer._shadowMapTime;d.depthMapTime=this.renderer._depthMapTime;
d.forwardTime=this.renderer._forwardTime;a=this.graphicsDevice._primsPerFrame;d.triangles=a[pc.PRIMITIVE_TRIANGLES]/3+Math.max(a[pc.PRIMITIVE_TRISTRIP]-2,0)+Math.max(a[pc.PRIMITIVE_TRIFAN]-2,0);d.cullTime=this.renderer._cullTime;d.sortTime=this.renderer._sortTime;d.skinTime=this.renderer._skinTime;d.instancingTime=this.renderer._instancingTime;for(b=d.otherPrimitives=0;b<a.length;b++)b<pc.PRIMITIVE_TRIANGLES&&(d.otherPrimitives+=a[b]),a[b]=0;this.renderer._camerasRendered=0;this.renderer._materialSwitches=
0;this.renderer._shadowMapUpdates=0;this.graphicsDevice._shaderSwitchesPerFrame=0;this.renderer._cullTime=0;this.renderer._sortTime=0;this.renderer._skinTime=0;this.renderer._instancingTime=0;d=this.stats.drawCalls;d.forward=this.renderer._forwardDrawCalls;d.depth=this.renderer._depthDrawCalls;d.shadow=this.renderer._shadowDrawCalls;d.skinned=this.renderer._skinDrawCalls;d.immediate=this.renderer._immediateRendered;d.instanced=this.renderer._instancedDrawCalls;d.removedByInstancing=this.renderer._removedByInstancing;
d.total=this.graphicsDevice._drawCallsPerFrame;d.misc=d.total-(d.forward+d.depth+d.shadow);this.renderer._depthDrawCalls=0;this.renderer._shadowDrawCalls=0;this.renderer._forwardDrawCalls=0;this.renderer._skinDrawCalls=0;this.renderer._immediateRendered=0;this.renderer._instancedDrawCalls=0;this.renderer._removedByInstancing=0;this.graphicsDevice._drawCallsPerFrame=0;this.stats.misc.renderTargetCreationTime=this.graphicsDevice.renderTargetCreationTime;d=this.stats.particles;d.updatesPerFrame=d._updatesPerFrame;
d.frameTime=d._frameTime;d._updatesPerFrame=0;d._frameTime=0},setCanvasFillMode:function(a,b,c){this._fillMode=a;this.resizeCanvas(b,c)},setCanvasResolution:function(a,b,c){this._resolutionMode=a;a===pc.RESOLUTION_AUTO&&void 0===b&&(b=this.graphicsDevice.canvas.clientWidth,c=this.graphicsDevice.canvas.clientHeight);this.graphicsDevice.resizeCanvas(b,c)},isFullscreen:function(){return!!document.fullscreenElement},enableFullscreen:function(a,b,c){a=a||this.graphicsDevice.canvas;var d=function(){b();
document.removeEventListener("fullscreenchange",d)},f=function(){c();document.removeEventListener("fullscreenerror",f)};b&&document.addEventListener("fullscreenchange",d,!1);c&&document.addEventListener("fullscreenerror",f,!1);a.requestFullscreen?a.requestFullscreen(Element.ALLOW_KEYBOARD_INPUT):c()},disableFullscreen:function(a){var b=function(){a();document.removeEventListener("fullscreenchange",b)};a&&document.addEventListener("fullscreenchange",b,!1);document.exitFullscreen()},isHidden:function(){return document[this._hiddenAttr]},
onVisibilityChange:function(a){this.isHidden()?this._audioManager.suspend():this._audioManager.resume()},resizeCanvas:function(a,b){if(this._allowResize){var c=window.innerWidth,d=window.innerHeight;if(navigator.isCocoonJS)a=c,b=d,this.graphicsDevice.resizeCanvas(a,b);else{if(this._fillMode===pc.FILLMODE_KEEP_ASPECT){var f=this.graphicsDevice.canvas.width/this.graphicsDevice.canvas.height;f>c/d?(a=c,b=a/f):(b=d,a=b*f)}else this._fillMode===pc.FILLMODE_FILL_WINDOW&&(a=c,b=d);this.graphicsDevice.canvas.style.width=
...
e=0,h=f.length;e<h;e++)f[e].pitch=b.pitch*c},onSetRefDistance:function(a,b,c){a=this.data.slots;for(var d in a)if(b=a[d],!b.overlap){b=b.instances;for(var f=0,e=b.length;f<e;f++)b[f].refDistance=c}},onSetMaxDistance:function(a,b,c){a=this.data.slots;for(var d in a)if(b=a[d],!b.overlap){b=b.instances;for(var f=0,e=b.length;f<e;f++)b[f].maxDistance=c}},onSetRollOffFactor:function(a,b,c){a=this.data.slots;for(var d in a)if(b=a[d],!b.overlap){b=b.instances;for(var e=0,g=b.length;e<g;e++)b[e].rollOffFactor=
...
e=this._parent.element.height,h=this._parent.element.pivot.x,m=this._parent.element.pivot.y):g&&(e=g.screen.resolution,b=e.x/g.screen.scale,e=e.y/g.screen.scale);a._anchorTransform.setTranslate(b*(a.anchor.x-h),-(e*(m-a.anchor.y)),0);a._anchorDirty=!1;a._calculateLocalAnchors()}a._sizeDirty&&this.element._calculateSize();if(this.dirtyWorld)for(null===this._parent?this.worldTransform.copy(this.localTransform):(this._parent.element?a._screenToWorld.mul2(this._parent.element._modelTransform,a._anchorTransform):
